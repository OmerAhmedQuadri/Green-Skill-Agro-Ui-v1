...
export function SignupPage() {
  const { register, loginWithGoogle, setAuthView, authError, setAuthError } = useAuth();
      ...
      <main className="auth-main-wrapper">
        <div className="auth-card">
          ...
          <div className="auth-card-header">
            <h1 className="auth-card-title">{t('signupTitle')}</h1>
            <p className="auth-card-subtitle">{t('signupSubtitle')}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            {/* Phone */}
            <div className="auth-form-group">
              <label className="auth-label">{t('phoneLabel')}</label>
              <div className="auth-input-wrapper">
            ...
            {/* Google Signup Integration Button */}
            <button
              type="button"
